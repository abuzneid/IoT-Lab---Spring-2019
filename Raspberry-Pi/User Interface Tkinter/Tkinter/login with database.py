...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        b_create_account.grid(row=4, column=1, padx=10,pady=10, sticky="NSEW")
...
class PageOne(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="Page One!!!", font=("arial",30))
        label.grid(row=0,column=0,pady=10,padx=10,sticky="nsew")

        button1 = tk.Button(self, text="Back to Home",
                            command=lambda: controller.show_frame(StartPage),bg="grey")
...
class CreateUser(tk.Frame):
    ...
    def button_handler_submit(self):
        ...
        #messagebox.showinfo(self,text="user {}  and password {} created ".format(e_user_name_v,e_pas_v))
        self.controller.show_frame(PageOne)
